...
export class Mig1734811047223 implements MigrationInterface {
    name = 'Mig1734811047223'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "text_snippet" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "text" character varying NOT NULL, "bookTitle" character varying NOT NULL, "bookAuthor" character varying NOT NULL, "note" character varying NOT NULL, "location" character varying NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_faa9e995b8fcc54435feb168239" PRIMARY KEY ("id"))`);
